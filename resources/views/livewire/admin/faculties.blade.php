            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        Here you can manage all faculties in the system.
                    </div>
                </div>

                <div class="p-6">
                    <div class="flex justify-between mb-4">
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search faculties..."
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($faculties as $faculty)
                                <tr>
                                    <td class="px-6 py-4 whitespace-no-wrap">{{ $faculty->name }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                        <button wire:click="editFaculty({{ $faculty->id }})"
                                            class="text-indigo-600 hover:text-indigo-900">Edit</button>
                                        <button wire:click="deleteFacultyConfirm({{ $faculty->id }})"
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                <div
                    ...
                    <h3 class="text-2xl font-bold">{{ $editMode ? 'Edit Faculty' : 'Create Faculty' }}</h3>
                ...
                <form wire:submit.prevent="{{ $editMode ? 'updateFaculty' : 'storeFaculty' }}" class="p-6">
                    <div class="mb-4">
